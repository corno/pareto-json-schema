import * as sh from "lib/schemas/schema_for_legacy_json/shorthands/manual"
        ...
        "": sh.v.multiple_types(
            {
                ...
                'object': sh.m.object_static({
                    ...
                    */
                    ...
                    "dependencies": sh.property(
                        sh.v.object_dynamic(
                            sh.v.one_of({
                                "legacy": sh.v.array_dynamic(
                                    sh.v.string()),
                                "standard": sh.v.reference_internal(""),
                            })), 'optional'),
                    "definitions": sh.property(
                        sh.v.object_dynamic(
                            sh.v.reference_internal("")), 'optional'), //8.2.4
                    //recursiveAnchor
                    //recursiveRef
                    ...
                    */
                    "$id": sh.property(
                        sh.v.string(), 'optional'), //8.2.1
                    "$schema": sh.property(
                        sh.v.string(), 'optional'), //8.1.1
                    "$ref": sh.property(
                        sh.v.string(), 'optional'), //8.2.3.1
                    "$anchor": sh.property(
                        sh.v.string(), 'optional'), //8.2.?
                    "$dynamicRef": sh.property(
                        sh.v.string(), 'optional'), //8.2.3.2
                    "$dynamicAnchor": sh.property(
                        sh.v.string(), 'optional'), //8.2.?
                    "$vocabulary": sh.property(
                        sh.v.object_dynamic(
                            sh.v.boolean()), 'optional'), //8.1.2
                    "$comment": sh.property(
                        sh.v.string(), 'optional'), //8.3
                    "$defs": sh.property(
                        sh.v.object_dynamic(
                            sh.v.reference_internal("")), 'optional'), //8.2.4
                    ...
                    */
                    ...
                    "prefixItems": sh.property(
                        sh.v.array_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.3.1.1
                    "items": sh.property(
                        sh.v.multiple_types( //10.3.1.2
                            {
                                'array': sh.m.array_dynamic(
                                    sh.v.reference_internal("")), //deprecated, replaced by prefixItems
                            },
                            //"schema", <--- fix this
                        ), 'optional'),
                    "contains": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.3.1.3
                    ...
                    "additionalProperties": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.3.2.3
                    "properties": sh.property(
                        sh.v.object_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.3.2.1
                    "patternProperties": sh.property(
                        sh.v.object_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.3.2.2
                    "dependentSchemas": sh.property(
                        sh.v.object_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.2.2.4
                    "propertyNames": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.3.2.4 (this is weird, but it really is a schema, not a string)
                    ...
                    "if": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.2.2.1
                    "then": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.2.2.2
                    "else": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.2.2.3

                    //applying subschemas with logic https://json-schema.org/draft/2020-12/json-schema-core#name-keywords-for-applying-subsch
                    "allOf": sh.property(
                        sh.v.array_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.2.1.1
                    "anyOf": sh.property(
                        sh.v.array_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.2.1.2
                    "oneOf": sh.property(
                        sh.v.array_dynamic(
                            sh.v.reference_internal("")), 'optional'), //10.2.1.3
                    "not": sh.property(
                        sh.v.reference_internal(""), 'optional'), //10.2.1.4
                    ...
                    */
                    "type": sh.property(
                        sh.v.multiple_types( //6.1.1
                            {
                                'string': sh.m.string(),
                                'array': sh.m.array_dynamic(
                                    sh.v.enum_({ "array": null, "boolean": null, "null": null, "number": null, "object": null, "string": null })),
                            }
                        ), 'optional'),
                    "const": sh.property(
                        sh.v.any(), 'optional'), //6.1.3
                    "enum": sh.property(
                        sh.v.array_dynamic(
                            sh.v.any()), 'optional'), //6.1.2

                    //numeric instance https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-num
                    "multipleOf": sh.property(
                        sh.v.number(), 'optional'), //6.2.1
                    "maximum": sh.property(
                        sh.v.number(), 'optional'), //6.2.2
                    "exclusiveMaximum": sh.property(
                        sh.v.number(), 'optional'), //6.2.3
                    "minimum": sh.property(
                        sh.v.number(), 'optional'), //6.2.4
                    "exclusiveMinimum": sh.property(
                        sh.v.number(), 'optional'), //6.2.5

                    //strings 6.3 https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-str
                    "maxLength": sh.property(
                        sh.v.number(), 'optional'), //6.3.1
                    "minLength": sh.property(
                        sh.v.number(), 'optional'), //6.3.2
                    "pattern": sh.property(
                        sh.v.string(), 'optional'), //6.3.3

                    "maxItems": sh.property(
                        sh.v.number(), 'optional'), //6.4.1
                    "minItems": sh.property(
                        sh.v.number(), 'optional'), //6.4.2
                    "uniqueItems": sh.property(
                        sh.v.boolean(), 'optional'), //6.4.3
                    "maxContains": sh.property(
                        sh.v.number(), 'optional'), //6.4.4
                    "minContains": sh.property(
                        sh.v.number(), 'optional'), //6.4.5
                    "maxProperties": sh.property(
                        sh.v.number(), 'optional'), //6.5.1
                    "minProperties": sh.property(
                        sh.v.number(), 'optional'), //6.5.2
                    "required": sh.property(
                        sh.v.array_dynamic(
                            sh.v.string()), 'optional'), //6.5.3
                    "dependentRequired": sh.property(
                        sh.v.object_dynamic(
                            sh.v.array_dynamic(
                                sh.v.string())), 'optional'), //6.5.4
                    ...
                    */
                    ...
                    "title": sh.property(
                        sh.v.string(), 'optional'), //9.1
                    "description": sh.property(
                        sh.v.string(), 'optional'), //9.1
                    "default": sh.property(
                        sh.v.any(), 'optional'), //9.2
                    "deprecated": sh.property(
                        sh.v.boolean(), 'optional'), //9.3
                    "readOnly": sh.property(
                        sh.v.boolean(), 'optional'), //9.4
                    "writeOnly": sh.property(
                        sh.v.boolean(), 'optional'), //9.4
                    "examples": sh.property(
                        sh.v.array_dynamic(
                            sh.v.any()), 'optional'), //9.5
                    ...
                    */
                    ...
                    "contentEncoding": sh.property(
                        sh.v.string(), 'optional'), //8.3
                    "contentMediaType": sh.property(
                        sh.v.string(), 'optional'), //8.4
                    "contentSchema": sh.property(
                        sh.v.reference_internal(""), 'optional'), //8.5
                    ...
                    */
                    ...
                    "additionalItems": sh.property(
                        sh.v.reference_internal(""), 'optional'), // deprecated

                    //kubernetes extensions
                    "x-kubernetes-group-version-kind": sh.property(
                        sh.v.any(), 'optional'),
                    "x-kubernetes-list-map-key": sh.property(
                        sh.v.any(), 'optional'),
                    "x-kubernetes-list-map-keys": sh.property(
                        sh.v.any(), 'optional'),
                    "x-kubernetes-list-type": sh.property(
                        sh.v.any(), 'optional'),
                    "x-kubernetes-patch-merge-key": sh.property(
                        sh.v.any(), 'optional'),
                    "x-kubernetes-patch-strategy": sh.property(
                        sh.v.any(), 'optional'),
                    "x-kubernetes-unions": sh.property(
                        sh.v.any(), 'optional'),


                    //abc
                    "abcAreAllocationMethodsHomogeneous": sh.property(
                        sh.v.any(), 'optional'),
                    "abcDoMaterialIDsExist": sh.property(
                        sh.v.any(), 'optional'),
                    "abcHasNonOverlappingTimeDependentValues": sh.property(
                        sh.v.any(), 'optional'),
                    "abcHasUninterruptedTimeDependentValues": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsAcyclic": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsAfter0001-01-01": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsBefore9999-12-31": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsExpirationDateOnOrAfterManufactureDate": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsExpirationDateOnOrAfterReleaseDate": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsFirstDayOfMonth": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsLastDayOfMonth": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsReleaseDateOnOrAfterManufactureDate": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsReleaseDateOnOrAfterPlanDate": sh.property(
                        sh.v.any(), 'optional'),
                    "abcIsValidColor": sh.property(
                        sh.v.any(), 'optional'),
                    "abcNoDuplicateValuesForOrderingProperty": sh.property(
                        sh.v.any(), 'optional'),
                    ...
                    "$dynamic": sh.property(
                        sh.v.any(), 'optional'), //FIXME
                    "id": sh.property(
                        sh.v.string(), 'optional'), //FIXME
                    "allowTrailingCommas": sh.property(
                        sh.v.boolean(), 'optional'), //FIXME
                    ...
                    "markdownDescription": sh.property(
                        sh.v.any(), 'optional'),
                    ...
                    "x-intellij-enum-metadata": sh.property(
                        sh.v.any(), 'optional'),
                    "x-intellij-html-description": sh.property(
                        sh.v.any(), 'optional'),
                    "x-intellij-language-injection": sh.property(
                        sh.v.any(), 'optional'),
                    "x-taplo": sh.property(
                        sh.v.any(), 'optional'),
                    "x-taplo-info": sh.property(
                        sh.v.any(), 'optional'),
                    "x-tombi-array-values-order": sh.property(
                        sh.v.any(), 'optional'),
                    "x-tombi-table-keys-order": sh.property(
                        sh.v.any(), 'optional'),
                    "x-tombi-toml-version": sh.property(
                        sh.v.any(), 'optional'),
                    "XrayScan": sh.property(
                        sh.v.any(), 'optional'),
                })
            },
        ),
