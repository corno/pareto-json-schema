...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/schema_for_legacy_json/signatures/refiners/astn_parse_tree.js"

import * as t_out from "../../../../../../interface/generated/liana/schemas/schema_for_legacy_json/data.js"
        ...
        ($, $t): t_out.Const_Value => {
            switch ($t) {
                case 'array':
                    return p_change_context(
                        $['value'],
                        ($) => ['array', p_.from.list(v_unmarshalled_from_parse_tree.List(
                                $,
                                ($) => abort(
                                    $,
                                ),
