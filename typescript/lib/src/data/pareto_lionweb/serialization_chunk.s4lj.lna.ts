    ...
    },
    {
        "": sh.v.object_dynamic(sh.v.object_static({
            ...
            "languages": sh.property(sh.v.array_dynamic(sh.v.object_static({
                "key": sh.property(sh.v.reference_internal("$defs/key")),
                "version": sh.property(sh.v.reference_internal("$defs/version")),
            }))),
            "nodes": sh.property(sh.v.array_dynamic(sh.v.object_static({
                "id": sh.property(sh.v.reference_internal("$defs/id")),
                "classifier": sh.property(sh.v.reference_internal("$defs/metaPointer")),
                "properties": sh.property(sh.v.array_dynamic(sh.v.object_static({
                    "property": sh.property(sh.v.reference_internal("$defs/metaPointer")),
                    "value": sh.property(sh.v.one_of({
                        "string": sh.v.string(),
                        "null": sh.v.null_(),
                    })),
                }))),
                "containments": sh.property(sh.v.array_dynamic(sh.v.object_static({
                    "containment": sh.property(sh.v.reference_internal("$defs/metaPointer")),
                    "children": sh.property(sh.v.array_dynamic(sh.v.string())),
                }))),
                "references": sh.property(sh.v.array_dynamic(sh.v.object_static({
                    "reference": sh.property(sh.v.reference_internal("$defs/metaPointer")),
                    "targets": sh.property(sh.v.array_dynamic(sh.v.object_static({
                        "resolveInfo": sh.property(sh.v.string()),
                        "reference": sh.property(sh.v.one_of({
                            "string": sh.v.string(),
                            "null": sh.v.null_(),
                        })),
                    }))),
                ...
                "parent": sh.property(sh.v.one_of({
                    "string": sh.v.string(),
                    "null": sh.v.null_(),
                })),
            })))
